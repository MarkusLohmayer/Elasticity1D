...
%\setmainlanguage{american} % [spelling=new,babelshorthands=true]{german}
%\usepackage{fontspec}
%\usepackage{relsize}
...
\usepackage{amsmath, amsbsy, amssymb, amsfonts, xfrac, bm, cancel}
...
\include{sections/traditional_beams/traditional_beams}


%-------------------------------------------------------------------------------
% include section cosserat_rods
\include{sections/cosserat_rods/cosserat_rods}
